...
@section('title', 'Thêm trò chơi mới')

@section('content')
<div class="py-6">
    <div class="mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center">
            <h1 class="text-2xl font-semibold text-gray-900">Thêm trò chơi mới</h1>
                ...
                <div class="px-4 py-5 sm:p-6">
                    <div class="grid grid-cols-1 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name') }}" placeholder="Nhập tên trò chơi" required
                        ...
                        <div>
                            ...
                            <input type="text" name="slug" id="slug" value="{{ old('slug') }}" placeholder="lien-quan-mobile" required
                                   class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" rows="3" placeholder="Nhập mô tả cho trò chơi"
...
@push('scripts')
<script>
    // Tự động tạo slug khi nhập tên trò chơi
