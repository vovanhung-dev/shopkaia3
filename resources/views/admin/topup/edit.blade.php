                    ...
                    <div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="mt-2">
                                ...
                                <img src="{{ asset('storage/'.$service->thumbnail) }}" alt="{{ $service->name }}" class="mt-1 h-32 object-cover rounded-md">
                            </div>
                            @endif
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            @if($service->banner)
                            <div class="mt-2">
                                <p class="text-sm font-medium text-gray-700">Banner hiện tại:</p>
                                <img src="{{ asset('storage/'.$service->banner) }}" alt="{{ $service->name }}" class="mt-1 h-32 object-cover rounded-md">
                            </div>
                            @endif
                        </div>
